      ...
      <div className="main-form">
        <div className="synap-context">
          ...
          <p className="synap-content-text">
            ...
            comfortable and user-friendly space for people to share their
            beliefs, collaborate, and learn from one another. The goal is to
            create a community of like-minded individuals who can contribute to
            the ethical advancement of these fields and make a positive impact
            on societ
          </p>
        </div>
